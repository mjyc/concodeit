...
await waitForOne(promisify2(async cb => {
  result = (await setMessage('My name is Meebo')); if (_stop["]jWX9RV6AVP}dewN6$qm"]) return;
  result = (await say('My name is Meebo')); if (_stop["]jWX9RV6AVP}dewN6$qm"]) return;
  result = (await gesture("HAPPY")); if (_stop["]jWX9RV6AVP}dewN6$qm"]) return;
  _stop["+{,qUHa{0X-LISH{7D.Y"] = false; if (_stop["]jWX9RV6AVP}dewN6$qm"]) return;
  await waitForOne(promisify2(async cb => {
    result = (await setMessage('I\'m made of a touch monitor and a robot arm')); if (_stop["+{,qUHa{0X-LISH{7D.Y"]) return; if (_stop["]jWX9RV6AVP}dewN6$qm"]) return;
    result = (await say('I\'m made of a touch monitor and a robot arm')); if (_stop["+{,qUHa{0X-LISH{7D.Y"]) return; if (_stop["]jWX9RV6AVP}dewN6$qm"]) return;
    await waitForAll(promisify2(async cb => {
      result = (await setMessage('Nice to meet you')); if (_stop["+{,qUHa{0X-LISH{7D.Y"]) return; if (_stop["]jWX9RV6AVP}dewN6$qm"]) return;
    ...
    result = (await say('Goodbye')); if (_stop["+{,qUHa{0X-LISH{7D.Y"]) return; if (_stop["]jWX9RV6AVP}dewN6$qm"]) return;
    cb(null, null); if (_stop["]jWX9RV6AVP}dewN6$qm"]) return;
  })()); if (_stop["]jWX9RV6AVP}dewN6$qm"]) return;
...
_stop["]jWX9RV6AVP}dewN6$qm"] = true;
